      ...
      files: [
        {
          ...
          fileSize: 842000,
          storageKey: `${sealedVaultId}/release-requests/release-1/death-certificate.jpg`,
        },
      ],
      ...
      files: [
        {
          ...
          contentType: "application/pdf",
          fileSize: 1240000,
          storageKey: `${sealedVaultId}/release-requests/release-2/death-certificate-clear.pdf`,
        },
      ],
